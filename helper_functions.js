    ...
    if ($("#condition_text6").css("display") == "none") {
        ...
        if (experiment.competition_condition == 0) {
            text += '<span class="block-text">Before we begin, we will show you the results from a previous round '+
                        ...
                        'and an indication of whether or not the response was <b>correct</b> and <b>how long it took</b> for DW to respond. (Note that the unscrambler must respond within the first 10 seconds.)</span><br>';
